      ...
      >
        <table className="w-full text-right text-xs tabular-nums">
          <thead className="sticky top-0 z-10 bg-card">
            <tr>
              <th className="label-cell px-3 py-2 text-left font-medium">
                Lap
              </th>
              <th className="numeric-cell px-2 py-2 font-medium">Time</th>
              <th className="numeric-cell px-2 py-2 font-medium">
                {pace ? "Pace" : "Speed"}
              </th>
              {power && (
                <th className="numeric-cell px-2 py-2 font-medium">Power</th>
              )}
              {heartRate && (
                <th
                  className="numeric-cell px-2 py-2 font-medium"
          ...
          <tbody>
            {intervals.map(({ lap, point }, index) => (
              ...
              >
                <td className="label-cell px-3 py-2 text-left">
                  <button
                    type="button"
                    className="text-left"
                    onClick={(event) => {
