...
type Goals = { duration_minutes?: number; power_watts?: number; pace_seconds_per_unit?: number }
...
export function gradeWorkoutCompletion(status: string, planned: Goals, actual: Goals): CompletionGrade {
  ...
  const checks = [
    ...
    { target: planned.power_watts, actual: actual.power_watts, green: 0.05, orange: 0.15 },
    { target: planned.pace_seconds_per_unit, actual: actual.pace_seconds_per_unit, green: 0.05, orange: 0.15 },
